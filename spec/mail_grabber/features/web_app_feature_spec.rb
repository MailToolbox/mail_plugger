...
RSpec.describe 'MailGrabber Web App', type: :feature do
  ...
  let(:message) do
    ...
    mail.attachments.inline['mail_plugger800x500.png'] =
      File.read(File.expand_path('../../images/mail_plugger800x500.png',
      ...
      Mail::Part.new do
        ...
        body "<!DOCTYPE html>
          <html>
            ...
            <body>
              <h1>This is HTML</h1>
              <img src=\"#{mail.attachments['mail_plugger800x500.png'].url}\"/>
              <p>Test email body</p>
            </body>
          </html>"
      end
